...
const noRedundantTransitionWhenGivingFeedbackForConfusionWithHint: SessionData =
  {
    dialogState: {
...
export default noRedundantTransitionWhenGivingFeedbackForConfusionWithHint;
